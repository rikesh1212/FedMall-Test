...
final_df['QTY_UNIT'] = final_df['QTY_UNIT'].fillna('1')
...
final_df['VENDPART'] = final_df['VENDPART'].astype(str).str.replace('*','-')
final_df['VENDPART'] = final_df['VENDPART'].astype(str).str.replace('"','')
# final_df['PRODNAME'] = final_df['PRODNAME'].astype(str).str.replace('"','')

# final_df['GSAPRICE'] = final_df['GSAPRICE'].round(2)
final_df['GSAPRICE'] = final_df['GSAPRICE'].astype(str).str.replace('$','')
final_df['GSAPRICE'] = final_df['GSAPRICE'].astype(str).str.replace(',','')
final_df['GSAPRICE'] = final_df['GSAPRICE'].round(2)
final_df['GSAPRICE'] = final_df['GSAPRICE'].apply('{:.2f}'.format)
...
final_df['PRODDESC'] = final_df['PRODDESC'].astype(str).str.strip()
...
final_df['LONG_DESCRIPTION'] = final_df['LONG_DESCRIPTION'].astype(str).str.strip()
final_df['LONG_DESCRIPTION'] = final_df['LONG_DESCRIPTION'].astype(str).str.replace('"','-')
final_df['LONG_DESCRIPTION'] = final_df['LONG_DESCRIPTION'].astype(str).str.replace('\t',' ')

# final_df['TEMPRICE'] = final_df['TEMPRICE'].astype(float).round(2)
final_df['TEMPRICE'] = final_df['TEMPRICE'].apply('{:.2f}'.format)
